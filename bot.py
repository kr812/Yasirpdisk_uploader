...
async def pdisk_up(link):
    if ('pdisk' in link or 'wslinker' in link or 'dplinks' in link or 'vivurl' in link or 'cdinks' in link or 'kuklink' in link or 'kofilink' in link or 'cofilink' in link or 'bit' in link or 'vdshort' in link or link in 'vidrivers' or 'dplinks' in link):
